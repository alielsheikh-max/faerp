...
export default function AnalyticsDashboard({
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
      ...
      {/* ── 2. Three-column: Insights | MoM Bars | Strategy ─────────────── */}
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "16px", alignItems: "start" }}>
            ...
            {insights.map((ins, idx) => {
              ...
              return (
                <div key={idx} style={{
                  ...
                  <div>
                    <div style={{ fontSize: "9.5px", fontWeight: 800, textTransform: "uppercase" as const, letterSpacing: "0.08em", color: insLeftBorders[idx % insLeftBorders.length], marginBottom: "3px" }}>{ins.label}</div>
        ...
        <div style={{ padding: "20px", borderRadius: "16px", background: "var(--bg-elevated)", border: "1px solid var(--border)" }}>
          <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: "14px" }}>
            <div>
              <p style={{ fontSize: "9px", fontWeight: 800, textTransform: "uppercase" as const, letterSpacing: "0.08em", color: "var(--text-muted)", margin: "0 0 4px" }}>Month-over-Month</p>
              <h2 style={{ fontSize: "15px", fontWeight: 800, margin: "0 0 3px" }}>Price Breakdown</h2>
              <p style={{ fontSize: "10px", color: "var(--text-muted)", margin: 0, fontStyle: "italic" as const }}>
                Avg, low & high quote per month
              </p>
            </div>
            <span style={{ fontSize: "10px", fontWeight: 700, background: "var(--bg-subtle)", border: "1px solid var(--border)", borderRadius: "99px", padding: "2px 8px", color: "var(--text-muted)", whiteSpace: "nowrap" as const }}>
        ...
        <div style={{ padding: "20px", borderRadius: "16px", background: "var(--bg-elevated)", border: "1px solid var(--border)" }}>
          <div style={{ marginBottom: "14px" }}>
            <p style={{ fontSize: "9px", fontWeight: 800, textTransform: "uppercase" as const, letterSpacing: "0.08em", color: "var(--text-muted)", margin: "0 0 4px" }}>Markup Advisor</p>
      ...
      <div style={{ padding: "20px 24px", borderRadius: "16px", background: "var(--bg-elevated)", border: "1px solid var(--border)" }}>
        <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", marginBottom: "16px" }}>
          <div>
            <p style={{ fontSize: "9px", fontWeight: 800, textTransform: "uppercase" as const, letterSpacing: "0.08em", color: "var(--text-muted)", margin: "0 0 4px" }}>Competitiveness Ranking</p>
          ...
          <span style={{ fontSize: "10px", fontWeight: 700, background: "var(--bg-subtle)", border: "1px solid var(--border)", borderRadius: "99px", padding: "3px 10px", color: "var(--text-muted)", whiteSpace: "nowrap" as const }}>
                ...
                >
                  ...
                  <div>
                    <div style={{ display: "flex", justifyContent: "space-between", fontSize: "10px", marginBottom: "5px" }}>
                      <span style={{ color: "var(--text-muted)", fontStyle: "italic" as const }}>vs. market average</span>
                      <span style={{
                    ...
                    <div style={{ fontSize: "9.5px", color: "var(--text-muted)", marginTop: "3px", fontStyle: "italic" as const }}>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8px" }}>
                    <div style={{ background: "var(--bg-elevated)", borderRadius: "8px", padding: "8px 10px" }}>
                      <div style={{ fontSize: "9px", color: "var(--text-muted)", textTransform: "uppercase" as const, letterSpacing: "0.06em", marginBottom: "2px" }}>Avg Price</div>
                      <div style={{ fontWeight: 900, fontSize: "13px", color }}>
                        {formatCurrency(sup.avgPrice)}
                      </div>
                    </div>
                    <div style={{ background: "var(--bg-elevated)", borderRadius: "8px", padding: "8px 10px" }}>
                      <div style={{ fontSize: "9px", color: "var(--text-muted)", textTransform: "uppercase" as const, letterSpacing: "0.06em", marginBottom: "2px" }}>Coverage</div>
      ...
      {/* ── 4. Category Matrix (category mode only) ──────────────────────── */}
      {itemsStats.length > 0 && (
        <div style={{ padding: "20px 24px", borderRadius: "16px", background: "var(--bg-elevated)", border: "1px solid var(--border)" }}>
          <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", marginBottom: "16px" }}>
            <div>
              <p style={{ fontSize: "9px", fontWeight: 800, textTransform: "uppercase" as const, letterSpacing: "0.08em", color: "var(--text-muted)", margin: "0 0 4px" }}>Category Matrix</p>
              ...
              return (
                <div key={row.itemId} style={{
                  ...
                  <div style={{ textAlign: "right" }}>
                    <div style={{ fontSize: "9px", color: "var(--text-muted)", textTransform: "uppercase" as const, marginBottom: "2px" }}>Min → Max</div>
                  ...
                  <div style={{ textAlign: "right" }}>
                    <div style={{ fontSize: "9px", color: "var(--text-muted)", textTransform: "uppercase" as const, marginBottom: "2px" }}>Avg</div>
                    <div style={{ fontWeight: 800, fontSize: "13px", color: "var(--primary)" }}>{formatCurrency(row.avg)}</div>
                  </div>
                  <div>
                    {isMostVolatile ? (
                      <span style={{ fontSize: "9px", fontWeight: 800, padding: "3px 8px", borderRadius: "99px", background: "rgba(239,68,68,0.12)", color: "#ef4444", border: "1px solid rgba(239,68,68,0.25)", whiteSpace: "nowrap" as const }}>⚠️ Most Volatile</span>
                    ) : isMostStable ? (
                      <span style={{ fontSize: "9px", fontWeight: 800, padding: "3px 8px", borderRadius: "99px", background: "rgba(16,185,129,0.12)", color: "#10b981", border: "1px solid rgba(16,185,129,0.25)", whiteSpace: "nowrap" as const }}>✅ Most Stable</span>
                    ) : (
